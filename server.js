...
app.use('/public_html/img/', express.static('./public_html/img'));

app.use('/public_html/css/', express.static('./public_html/css'));

app.use('/public_html/js/', express.static('./public_html/js'));
